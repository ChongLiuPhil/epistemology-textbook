...
历史 Work Log 默认不读，除非任务需要回顾、审计或解决 current/history 冲突。
...
`core/FORM_CORE.zh-CN.md` 保存稳定形式决定。当前 active artifact 是 Quarto HTML Web Edition。
...
6. 更新 Working Memory，使下一位协作者知道任务已完成和接下来做什么。
